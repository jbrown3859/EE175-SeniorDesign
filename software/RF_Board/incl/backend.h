...
enum State{INIT, WAIT, GET_RADIO_INFO, GET_RX_BUF_STATE, READ_RX_BUF, BURST_READ_RX, FLUSH_RX, GET_TX_BUF_STATE, WRITE_TX_BUF, BURST_WRITE_TX, FLUSH_TX, WRITE_RX_BUF, READ_TX_BUF};
